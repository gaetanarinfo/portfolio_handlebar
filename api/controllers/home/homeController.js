...
module.exports = {
    get: async(req, res) => {
        ...
        const articles = await Article.find({}).lean() // Cards Articles
        ...
        } else res.render('index', { error: error, projets, tutos, articles, galeries, title: 'Portfolio de Gaëtan Seigneur' })
    }
}